---
title: "Prophet with both doses of vaccine all age groups"
author: "Gauri Saran"
date: '2022-05-08'
output: html_document
---

## <b> Forecast Hospital cases using Prophet model using extra regressor variables from vaccine data for those who received both doses of vaccine in the all the different age groups (5-80). 3 days of forecast.</b>
...
model_cases <- add_regressor(model_cases, 'Percent_of_Ottawa_residents_5_1_dose')
...
model_cases <- add_regressor(model_cases, 'Percent_of_Ottawa_residents_5_2_dose')
model_cases <- add_regressor(model_cases, 'Percent_of_Ottawa_residents_12_2_dose')
model_cases <- add_regressor(model_cases, 'Percent_of_Ottawa_residents_18_2_dose')
model_cases <- add_regressor(model_cases, 'Percent_of_Ottawa_residents_30_2_dose')
model_cases <- add_regressor(model_cases, 'Percent_of_Ottawa_residents_40_2_dose')
model_cases <- add_regressor(model_cases, 'Percent_of_Ottawa_residents_50_2_dose')
model_cases <- add_regressor(model_cases, 'Percent_of_Ottawa_residents_60_2_dose')
model_cases <- add_regressor(model_cases, 'Percent_of_Ottawa_residents_70_2_dose')
model_cases <- add_regressor(model_cases, 'Percent_of_Ottawa_residents_80_2_dose')
...
future$Percent_of_Ottawa_residents_5_1_dose = final_data$Percent_of_Ottawa_residents_5_1_dose
future$Percent_of_Ottawa_residents_12_1_dose = final_data$Percent_of_Ottawa_residents_12_1_dose
...
future$Percent_of_Ottawa_residents_5_2_dose = final_data$Percent_of_Ottawa_residents_5_2_dose
future$Percent_of_Ottawa_residents_12_2_dose = final_data$Percent_of_Ottawa_residents_12_2_dose
future$Percent_of_Ottawa_residents_18_2_dose = final_data$Percent_of_Ottawa_residents_18_2_dose
future$Percent_of_Ottawa_residents_30_2_dose = final_data$Percent_of_Ottawa_residents_30_2_dose
future$Percent_of_Ottawa_residents_40_2_dose = final_data$Percent_of_Ottawa_residents_40_2_dose
future$Percent_of_Ottawa_residents_50_2_dose = final_data$Percent_of_Ottawa_residents_50_2_dose
future$Percent_of_Ottawa_residents_60_2_dose = final_data$Percent_of_Ottawa_residents_60_2_dose
future$Percent_of_Ottawa_residents_70_2_dose = final_data$Percent_of_Ottawa_residents_70_2_dose
future$Percent_of_Ottawa_residents_80_2_dose = final_data$Percent_of_Ottawa_residents_80_2_dose
```
...
The error metrics are high when model is regressed against only those who received both the doses of vaccine in all the age groups. 


#### <b>Component plot showing yearly and weekly trend of the model.</b>
The model trend shows a moderately strong linear increase in cases from January 2021 until January 2022.
The extra regressor plot shows the additive effect of regressors and it shows that both dose of vaccination in all the different age groups remains high until April/May 2021 and then shows a sharp decrease in July 2021 and then moderately increases after July 2021 until January 2022.
