...
Projection from model in Ottawa-Data branch
...
Projection from model in sims-update branch

```{r, echo=FALSE, warning=FALSE, message=FALSE}
source("../R/hosp_projections.R")
ott_test <- read.csv(file.path(getwd(), "../Data/OPH_projection_test.csv"))
hosp_fun(ott_test, "hosp_census", title = "Projected census of COVID-19 patients in Ottawa", y = "Census (# of patients)")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
source("../R/hosp_projections.R")
hosp_fun(ott_test, "hosp_admits", title = "Projected daily COVID-19 hospitalizations in Ottawa", y = "New admissions (# of patients)")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
source("../R/hosp_projections.R")
hosp_fun(ott_test, "vent_census", title = "Projected # of COVID-19 patients on ventilators in Ottawa", y = "# of patients")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
source("../R/hosp_projections.R")
hosp_fun(ott_test, "vent_admits", title = "Projected daily COVID-19 ventilator use in Ottawa", y = "# of patients")
```

---

## Death visualizations

```{r, echo=FALSE, warning=FALSE, message=FALSE}
source("../R/covid_visualization.R")
death_visualization(data1 = NULL, data2 = ott_observed, parameter = "new_deaths", title = "Observed new deaths in Ottawa", "# of deaths")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
source("../R/covid_visualization.R")
death_visualization(data1 = NULL, data2 = ott_observed, parameter = "cumulative_deaths", title = "Observed cumulative deaths in Ottawa", "# of deaths")
```