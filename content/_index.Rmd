...
- 50% physical distancing is a `r round(((no_intervention - current_intervention)/no_intervention*100), 0)`% reduction in peak hospitalizations from no prevention & control.

- 70% physical distancing is a `r round(((no_intervention - intervention_70)/no_intervention*100), 0)`% reduction in peak hospitalizations from no prevention & control.
...
> Doubling time refers the time it takes (in days) for the number of hospitalized patients to double in number.
