...
observed_figure(ott_observed, "Observed data", "Census (# of patients)")
```

> A doubling time for hospital census translates to an effective physical distancing of xx%. Note that there is a lag period between a change in physical distancing and the effect on hospital census. **[more](/more#distancing)**
