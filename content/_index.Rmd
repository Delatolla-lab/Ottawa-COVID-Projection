...
**`r more_less`** patients in hospital the this week, reflecting a current `r Dt_label` of **`r round(abs(exp_census[[2]][[3]]), 1)`** days (daily growth of `r round(exp_census[[4]][[3]], 4)`%).
