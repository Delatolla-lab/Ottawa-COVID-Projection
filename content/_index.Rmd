...
peak_projections$intervention <-
  factor(peak_projections$intervention, levels = c("Current distancing effectiveness", "20% reduction in physical distancing", "100% reduction in physical distancing"))
...
**`r paste(current, "to", reduction_20)`** peak patients in hospital between **`r paste(current_date, "&", reduction_20_date)`**. 

## Observed Hospital census {#doubling-time}

**NOTE:** Ottawa hospitalization data is missing from 2020-04-29 to 2020-05-04. Observed hospitalization data from The Ottawa Hospital will be added shortly.
...
The forecast of `r round(current, -1)` patients in hospital in `r paste(current_date)` is based on the previous weeks' physical distancing effectiveness of **`r round(effective_pd, 0)`%**.
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
source("../R/toh_projections.R")
TOH_fun(TOH_projections, "vent_census", title = "Projected census of COVID-19 hospitalizations at The Ottawa Hospital", y = "Census (# of patients)")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
source("../R/toh_projections.R")
TOH_fun(TOH_projections, "vent_admits", title = "Projected daily COVID-19 hospitalizations at The Ottawa Hospital", y = "New admissions (# of patients)")
```

## Death projections {#deaths}

Death projections have been omitted from the website. With the overwhelming majority of COVID-19 related deaths occurring in residents of LTC or retirement homes, it is difficult to estimate COVID-19 related deaths in the hospital. Many residents in LTC and retirement homes are in their last years of life and have advanced directives saying they (the resident) do not want advanced life support or transfer to the hospital if they have a life threatening illness.