...
peak_projections$intervention <-
  factor(peak_projections$intervention, levels = c("No prevention & control", "Current physical distancing", "70% physical distancing"))
library(tidyverse)
library(ggplot2)
...
> **Physical distancing means that there is a reduction in close contact between people.** For example, 50% physical refers to a 50% reduction in close contact between people. See [more](/more#distancing) for more details about physical distancing.
