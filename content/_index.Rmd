...
library(ggplot2)
h <- ggplot(peak_projections, aes(intervention, peak_hospital_census)) + geom_col(fill = c("#D62728", "#1F77B4", "#2CA02C")) +
  ...
  theme(panel.background = element_rect(fill = 'white'), plot.title = element_text(hjust = 0.5)) + geom_text(data = ) 
...
Click or hover over over top right of visualization for how to download, zoom and pan.
