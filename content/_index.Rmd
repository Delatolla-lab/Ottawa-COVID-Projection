...
## Observed census
exp_census <- calc_expected_values_for_n_weeks(data = TOH_observed, number_weeks = 3)
...
```
**NOTE:** Ottawa Public Health is updating their infomation system to the new COVID-19 Ottawa Database. Observed hospitalization data from The Ottawa Hospital will be used in the interim. Death & ICU projections have been omitted. 
...
**`r last(na.omit(TOH_observed$observed_census_ICU_p_acute_care))`** confirmed COVID-19 patients in hospital.

Including: **`r last(na.omit(TOH_observed$observed_census_acute_care))`** acute care patients. **`r last(na.omit(TOH_observed$observed_census_ICU))`** ICU patients.
...
ottawa_hosp <-
  reworked_figure(
    ...
    titles = c(y = "# of patients", x = "Date", title = "Observed census of COVID-19 hospitalizations at The Ottawa Hospital"),
    data = exp_census[[1]]
  )
...
Hospitalization projections predict the number of COVID-19 patients in hospital. The number of patients is based on "bed-days", which are the number of hospital beds occupied by patients on a given day.

---

```{r, echo=FALSE, warning=FALSE, message=FALSE}
source("../R/toh_projections.R")
TOH_fun(TOH_projections, "hosp_census", title = "Projected # of COVID-19 patients at The Ottawa Hospital", y = "# of patients")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
source("../R/toh_projections.R")
TOH_fun(TOH_projections, "vent_census", title = "Projected # of COVID-19 patients on ventilators at The Ottawa Hospital", y = "# of patients")
```
