...
reworked_figure(xaxis = "date", yaxis = list(list(type = "observed_data", y_column = "observed_census_ICU", name = "ICU census"), list(type = "observed_data", y_column = "observed_census_acute_care", name = "Acute care census")), titles = c(y = "Census (# of patients)", x = "Date", title = "Observed census of COVID-19 hospitalizations in Ottawa"), data = exp_census[[1]])

reworked_figure(xaxis = "Date", yaxis = list(list(type = "observed_data", y_column = "observed_new_RH", name = "RH"), list(type = "observed_data", y_column = "observed_new_LTCH", name = "LTCH")), titles = c(y = "Daily Observed cases", x = "Date", title = "YEEE"), data = test)
