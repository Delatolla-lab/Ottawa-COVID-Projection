...
## Observed hospital resource use

```{r, echo=FALSE, warning=FALSE, message=FALSE}
source("../R/lag_replacement.R")
source("../R/observed_data.R")

observed_figure(ott_observed, "Observed census of COVID-19 hospitalizations in Ottawa", "Census (# of patients)")
```

> A doubling time for hospital census translates to an effective physical distancing of xx%. Note that there is a lag period between a change in physical distancing and the effect on hospital census. **See [more](/more#distancing)**
