...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
observed_daily_ICU_p_acute_care <- list(type = "observed_data", y_column = "observed_new_ICU_p_acute_care", name = "Reported # of patients", color = "rgb(255, 127, 14)")
...
ICU_p_acute_care <-
  reworked_figure(
    xaxis = "date",
    yaxis = list(observed_daily_hospitalizations),
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
observed_daily_new_deaths <- list(type = "observed_data", y_column = "observed_new_deaths", name = "Reported # of patients", color = "rgb(214, 39, 40)")
