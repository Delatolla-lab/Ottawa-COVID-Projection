...
1) Short-term projections (2 to4 weeks) to inform the immediate need for hospital and critical care services for COVID-19 patients. 
...
1) *Daily hospital census for acute care and ICU patients in Ottawa*  
    ...
    - Census is defined as the number of patients hospitalized for COVID-19 on each day. 
...
A description of the model parameters and input data is [here](). 
