...
**X** confirmed COVID-19 patient in hospital.

Including: **Y** acute care patients. **Z** ICU patients. **X** ventilated patients.
...
**(more, fewer, about the same)** patients in hospital the following week, reflecting a current `r Dt_label` of **`r round(exp_census[[2]][[3]], 1)`** days (growth of X%).

### Long-range forecast

**X to y** peak patients in hospital between **X to y (DATE)**. 
...
- Hospital census `r Dt_label` of **`r round(exp_census[[2]][[3]], 1)`** days translates to current physical distancing effectiveness of approximately `r round(effective_pd, 0)`%. See More.
...
- 350 patients in XXl, based on current physical distancing effectiveness, or a `r round(((no_intervention - intervention_70)/no_intervention*100), 0)`% reduction in peak hospitalizations from no prevention & control.

- 40 patients in Apri, based on a physical distancing effectiveness of 70%.
...
For example, a physical distancing effectiveness of 70% means there is a 70% reduction close contact between people with and without COVID-19 infection . See [more](/more#distancing) for details about physical distancing.
