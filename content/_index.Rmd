...
death_visualization(data1 = NULL, data2 = ott_observed, parameter = "new_ICU_p_acute_care", title = "Observed daily COVID-19 hospitalizations of Ottawa residents", "# of patients", fillcolor = "orange")
```
