...
**`r last(na.omit(ott_observed$observed_census_ICU_p_acute_care))`** confirmed COVID-19 patients in The Ottawa Hospital.
...
ottawa_hosp <-
  reworked_figure(
    ...
    titles = c(y = "Census (# of patients)", x = "Date", title = "Observed census of COVID-19 hospitalizations in The Ottawa Hospital"),
    data = exp_census[[1]]
  )
