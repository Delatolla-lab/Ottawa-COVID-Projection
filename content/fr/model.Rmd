...
All data used to create projection models can be accessed at [Open Ottawa](https://open.ottawa.ca/datasets/covid-19-cases-and-deaths-in-ottawa). See 'COVID-19 cases and deaths`. Data used to create wastewater projection models can be accessed at [PHESD](https://github.com/Big-Life-Lab/PHESD).
