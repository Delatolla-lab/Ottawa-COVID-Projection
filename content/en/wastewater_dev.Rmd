...
The following plot illustrates daily covid-19 wasterwater viral signal along with various comparators including reported daily covid-19 cases and hospitalization census. This plot uses 7-day midpoint* averages for viral signal and daily covid-19 cases. Details on how midpoint averages are calculated can be seen below.
...
The following plot illustrates the percent change^ in the 7-day mean covid-19 wasterwater viral signal from the previous 7 days against the percent change in the 7-day mean in daily covid-19 cases from the previous 7 days. Details on how these percent changes are calculated can be seen below.
