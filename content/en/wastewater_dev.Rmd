...
Question: show 5 and 10 day change, or just 10 day change
```{r, echo=FALSE, warning=FALSE, message=FALSE}
reworked_figure(xaxis = "date", yaxis = list(change_N1_N2_5_day_call, change_N1_N2_10_day_call), yaxis2 = list(new_case_7_day_call), titles = c(y = "Percent change (%)", y2 = "Number of reported new cases", x = "Date", title = "Percent change in 5 or 10-day rolling average.^"), data = ott_covid_waste, yaxis_button = TRUE)
```

5, 7 or 10-day averages are rolling averages, calculated using the results for the previous days. The frequency of testing changes over time. Currently, Ottawa wastewater testing is performed 5 days each week.
...
^ Percent change in 5-day average is calculated by comparing the 5-day average (previous day 1 to 5) with a lagged 5-day average (days 6 to 10). Percent change in 10-day average is calculated comparing  1 to 10 days prior with days 11 to 19. 
