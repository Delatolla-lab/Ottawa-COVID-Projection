...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
reworked_figure(xaxis = "date", yaxis = list(n1_n2_7_day_call), yaxis2 = list(daily_viral_signal_call), titles = c(y = "Normalized viral copies*", y2 = "", x = "Date", title = "Covid-19 wastewater viral signal, Ottawa"), data = ott_covid_waste)
```
