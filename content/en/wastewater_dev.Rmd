...
<img src="/images/flu_image_21aug12.png" width="90%" height="90%"/> <!-- Will eventually need to transform this into a live figure and not a static image as well -->
...
p <- layout(p, yaxis = list(range = c(0.0000007042857, 0.0001350000), exponentformat="none", tickformat=".5f"))
p
```
...
p <- layout(p, yaxis = list(range = c(0.00001275000, 0.0002740), exponentformat="none", tickformat=".5f"))
p
```
```
