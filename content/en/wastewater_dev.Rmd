...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.asp = 0.75}
reworked_figure(xaxis = "date", yaxis = list(var_call), titles = c(y = "Proportion", y2 = "", x = "Date", title = "<b>Proportion of variant B.1.1.7 in wastewater, Ottawa</b>"), data = variant_data)
```
