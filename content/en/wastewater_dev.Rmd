...
The science supporting wastewater surveillance is rapidly evolving. See the [Methods](/model/) page for more information on how the samples where collected, access to the data, and how the plots were created. The plots are currently for research only and presented to the public for discussion. Wastewater surveillance has several uses, including:
...
The following plots below illustrate daily viral covid-19 wastewater signal in Ottawa. However, at this time, we recommend caution when interpreting daily and short-term variation in the viral signal. Covid-19 wastewater signal is helpful when interpreted alongside other covid-19 surveillance measures, taking into consideration the strengths and limitations of each measure. The accuracy of SARS-CoV-2 testing is improving, as scientists understand the role of factors such as differences in sewage systems and laboratory protocols.
