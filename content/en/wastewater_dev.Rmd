...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
reworked_figure(xaxis = "date", yaxis = list(change_N1_N2_5_day_call, change_N1_N2_10_day_call), yaxis2 = list(new_case_10_day_call), titles = c(y = "Percent change (%)", y2 = "Number of reported new cases", x = "Date", title = "Ottawa covid-19 viral signal in wastewater"), data = ott_covid_waste, yaxis_button = TRUE)
```
