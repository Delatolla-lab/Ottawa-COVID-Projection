...
The three plots below illustrate daily viral covid-19 wastewater signal in Ottawa. Unlike the number of active covid-19 cases, which underrepresents asymptomatic infections and may be subject to limited testing availability, wastewater surveillance captures most of the population with covid-19. The accuracy of SARS-CoV-2 testing is improving, as scientists understand more of the role of factors such as differences in sewage systems and laboratory protocols. Nonetheless, we recommend caution when interpreting daily and short-term variation in the viral signal. Covid-19 wastewater signal is helpful when interpreted alongside other covid-19 surveillance measures, taking into consideration the strengths and limitations of each measure. 
...
Wastewater surveillance provides a unique population perspective. For example, reported covid-19 cases underrepresents asymptomatic infection and it is subject to changing testing criteria. 
...
\* A 7-day average is generated by averaging the levels from a given day as well the three previous and three subsequent days. The average is termed “rolling” as it changes each day.  

\* For new cases, the reported date is the day the test is reported by the laboratory. Episode date is the approximate date of infection. Episode date is an estimate of the date of covid-19 infection. This date is calculated based on either the date of symptom onset, test date, or the date reported to the public health unit by the laboratory.

\* A central question in wastewater epidemiology is determining the proportion of the wastewater that is actually from humans and the proportion that is rain water, snow melt etc. Viral copy data is thus normalized using a seasonally stable fecal biomarker; pepper mild mottle virus (PMMoV). See [methods](/model/) for more details.
