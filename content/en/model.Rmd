...
---
This page has a brief description of methods used at 613covid with references for more information. Also included are all parameters used in projection models and links to all plot data. 
...
## Projections based on daily hospital & case data {#hospital-census}
...
Wastewater samples are collected Robert O. Pickard Environmental Centre (ROPEC) which collects and treats wastewater from 91.6% of Ottawa’s population. Currently samples hourly for 24 hours, five days a week from sludge (directly from the exit stream of the grit chamber units). The assay method has been validated in a national cross-laboratory study. Two viral regions of SARS-CoV-2 (N1 and N2) are assayed and standardized using the viral levels of Pepper Mild Mottle Virus (PMMV). The reported measure is the mean sample mean of N1 + N2 copies per copy of PMMV. 
