...
1) *Covid-19 short-term projections are created using the [Bayesian EpiNow2 model](https://epiforecasts.io/EpiNow2/) developed by the EpiForecasts team.*
    ...
    - Projections are based on observed covid-19 cases by reporting date. Time varying reproduction number are based on predicted date of infection, which is, in turn, estimated using reported incubation period and consideration for reporting delays. Future updates on 613covid.ca will cosider observed episode date for Ottawa cases.
...
Ottawa's wastewater data is available [here](https://github.com/Big-Life-Lab/covid-19-wastewater).
...
## Calculating physical distancing effectiveness {#distancing-effectiveness}
