...
ott_observed_covid <- ott_observed_covid[ott_observed_covid$date >= "2020-03-01",]
...
case_projection_plot(tidy_proj, obs_dat = ott_observed_covid,
...
ott_projections <- proj_generation(fit, lut, days_project = 100, day_start_reduction = 14, pct_change = 10)

# Create data set to visualize projections
projection_data <- case_projection_data(ott_projections, ott_observed_covid)

# Visualize projections
hosp_fun(projection_data, "new_cases", title = "Projected COVID-19 daily cases in Ottawa", y = "Daily cases", current_color = acute_col, current_shade = acute_shade, reduction_value = 10, reduction_color = reduction_col, reduction_shade = reduction_shade, increase_value = 10, increase_color = increase_col, increase_shade = increase_shade, observed_name = "Observed daily cases")
```
*Shaded area represents the 95% credible region