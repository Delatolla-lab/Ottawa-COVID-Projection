...
load("../../Model Validation/ww_projections_development/Data/historic_ww_proj.RData")
...
ww_proj_call <- list(type = "avg_data", y_column = "median", name = "Historic projected viral signal", short_name = "projections", color = proj_col, width = 4, showlegend = TRUE)
