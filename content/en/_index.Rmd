...
short_term_plot(
  ...
  title = "Short-term hospital census projections in Ottawa"
)
```
...
>**Interpretive caution:** Hospital projections can be less accurate at the beginning of new waves. Hospital projections are based on the projected transmission of cases. Case transmission can be lower in vaccinated people with a lower risk of hospitalization.
