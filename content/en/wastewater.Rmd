...
B.1.1.7: **not detected** beyond 2021-03-09
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
reworked_figure(xaxis = "date", yaxis = list(daily_viral_signal_call, n1_n2_7_day_call), titles = c(y = "Normalized viral copies*", y2 = "", x = "Date", title = "<b>Covid-19 wastewater viral signal, Ottawa</b>"), data = ott_covid_waste, vline = TRUE, vline_date = "2021-03-09")
```

*Dashed vertical line represents a change to automated extraction of wastewater samples.
