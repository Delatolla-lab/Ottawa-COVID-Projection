...
staff_incident_cases_7_day <- list(type = "observed_data", y_column = "covidPosAbs", name = "Observed COVID-19 cases in health care workers in Ottawa by episode date", short_name = "Health care worker cases", color = case_col, opacity = 0.15)
