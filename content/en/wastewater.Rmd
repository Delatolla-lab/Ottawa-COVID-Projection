...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
reworked_figure(xaxis = "date", yaxis = list(n1_n2_10_day_call), yaxis2 = list(active_case_5_day_call), titles = c(y = "SARS-CoV-2 wastewater copies per PMMV* copy", y2 = "# of active cases", x = "Date", title = "Average COVID-19 viral signal \nin wastewater with respect to active cases"), data = ott_covid_waste)
```
* PMMV = pepper mild mottle virus. See methods for more details.

```{r, echo=FALSE, warning=FALSE, message=FALSE}
reworked_figure(xaxis = "date", yaxis = list(change_N1_N2_10_day_call), yaxis2 = list(new_case_5_day_call), titles = c(y = "Percentage change (%)", y2 = "# of reported new cases", x = "Date", title = "Daily rate of change in COVID-19 \nviral signal with respect to new cases"), data = ott_covid_waste)
```
* PMMV = pepper mild mottle virus. See methods for more details.
