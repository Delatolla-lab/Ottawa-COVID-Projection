...
one_day_back <- curr_day - as.difftime(1, unit="days")
two_days_back <- curr_day - as.difftime(2, unit="days")
wwcollectdate<- insert_translation(localization_data, lang, "WWCollectDate", c(format(one_day_back, '%d %B, %Y')))
wwanalysesdate<- insert_translation(localization_data, lang, "WWAnalysesDate", c(format(two_days_back, '%d %B, %Y')))
```
