...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
reworked_figure(xaxis = "date", yaxis = list(new_case_call), yaxis2 = list(rolling_avg_call), titles = c(y = "# of new cases", y2 = "Copies per Copies PMMV", x = "Date", title = "Average COVID-19 viral signal in wastewater with respect to daily new cases"), data = ott_covid_waste)
```

```{r, echo=FALSE, warning=FALSE, message=FALSE}
reworked_figure(xaxis = "date", yaxis = list(active_case_call), yaxis2 = list(rolling_avg_call), titles = c(y = "# of active cases", y2 = "Copies per Copies PMMV", x = "Date", title = "Average COVID-19 viral signal in wastewater with respect to active cases"), data = ott_covid_waste)
```

```{r, echo=FALSE, warning=FALSE, message=FALSE}
reworked_figure(xaxis = "date", yaxis = list(hosp_call), yaxis2 = list(rolling_avg_call), titles = c(y = "# of patients", y2 = "Copies per Copies PMMV", x = "Date", title = "Average COVID-19 viral signal in wastewater with respect to hospital census"), data = ott_covid_waste)
```
