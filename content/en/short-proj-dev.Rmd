...
new_case_call <- list(type = "observed_data", y_column = "observed_new_cases", name = "Daily reported new cases", short_name = "Daily cases", color = case_col, opacity = 0.5)
...
proj_call <- list(type = "avg_data", y_column = "median", name = "Projections", short_name = "projections", color = proj_col)
...
reworked_figure(xaxis = "date", yaxis = list(new_case_call, proj_call), error_bands = TRUE, error_data = c("upper_90", "lower_90"), error_col = proj_shade, titles = c(y = "New Cases", y2 = "", x = "Date", title = "Examining historic case projections with case data"), data = plot_data, ticks = FALSE)
