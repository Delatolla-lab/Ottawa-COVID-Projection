...
Samples are screened for influenza once a week during the summer period. The website and plots are updated the day after processing. 

The next plot illustrates the 7-day rolling mean in daily influenza A wastewater viral signal. This number is the average of a week’s readings. Also on the graph is the Influenzas A percent positivity. 

<img src="/images/flu_image_21jun22.png" width = "90%" height = "90%"/>
