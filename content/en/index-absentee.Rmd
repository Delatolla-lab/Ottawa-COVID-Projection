...
#summary_estimates <- list(summary_estimates)
#save(summary_estimates, file = "../../Data/Historic Projections/summaryestimates_twoweekCovidEmployeeData.RData")

cov_proj <- load("../../Data/Historic Projections/projections_twoweekCovidEmployeeData.RData")

summary_proj <- load("../../Data/Historic Projections/summary_twoweekCovidEmployeeData.RData")
summary_estm <- load("../../Data/Historic Projections/summaryestimates_twoweekCovidEmployeeData.RData")

rt_proj <- load("../../Data/Historic Projections/rt_projections_twoweekCovidEmployeeData.RData")
...
source("../../R/epinow_functions.R")
# visualize epinow forecast
short_term_plot(projections = staff_rt_projection, obs_data = covid_data, obs_column = "covidPosAbs_pop", forecast_type = "R", ylab = "Rt of Health care worker cases (per 1000 people)", title = "Short-term COVID-19 positive staff projection in Ottawa", tick_labels_date = "%b %y", tick_period = "1 month")
```
