...
load("../../Data/Historic Projections/historic_cases_projections_twoweekCovidEmployeeData.RData")

# Transforming the Covid projections of the health care workers and the confidence intervals into rate per 1000 population
staff_cov_projections_2<- cases_forecast[[1]] %>% filter(variable == "reported_cases") %>% mutate(median = (median/7019)*1000) %>% mutate(upper_75 = (upper_75/7019)*1000) %>% mutate(lower_75 = (lower_75/7019)*1000)
