...
short_term_plot(projections = hosp_proj, obs_data = ott_observed, obs_column = "observed_census_ICU_p_acute_care", forecast_type = "reported_cases", ylab = "Hospital census", title = "Short-term hospital census projections in Ottawa", tick_labels_date = "%b %y", tick_period = "1 month", interval_num = interval_num)
```
...
source("../../R/epinow_functions.R")
# visualize epinow forecast
short_term_plot(projections = staff_cov_projections_3, obs_data = covid_data, obs_column = "covidPosAbs_pop", forecast_type = "R", ylab = "Rt of Health care worker cases (per 1000 people)", title = "Short-term COVID-19 positive staff projection in Ottawa", tick_labels_date = "%b %y", tick_period = "1 month", interval_num = interval_num)
```
