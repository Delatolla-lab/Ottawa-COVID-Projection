...
That being said, hurricanes and COVID-19 are not the same. The path and force of a hurricane can't be influenced, but the worse effects of COVID-19 can be avoided if we follow public health guidelines like staying home and practive physical distancing.  
...
A definition and description of physical distancing is [here](/more). 
...
See [model](/model) for a technical discussion about how physical distancing affects COVID-19 infectivity.

<div id="more-info-images" class="more-info-images">
<figure>
