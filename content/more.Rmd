...
## What is physical distancing {#distancing}
...
See [model](/model) for a technical discussion about how physical distancing affects COVID-19 spread.
...
Physical distancing effectiveness describes how fast COVID-19 spreads in Ottawa compared if there was no physical distancing. It is a mathematical calculation based on the observed doubling time (growth) of the hospital census for the previous week.

Physical distancing effectiveness is different from other measures the describe the level of physical distancing, including [surveys](https://www.ottawapublichealth.ca/en/reports-research-and-statistics/la-maladie-coronavirus-covid-19.aspx) or [community movement statistics](https://www.gstatic.com/covid19/mobility/2020-04-17_CA_Mobility_Report_en.pdf). 

At the beginning of COVID-19 in Ottawa, new cases (and hospitalization) doubled every 3 to 4 days. The increase means that five patients in the hospital on Monday for COVID-19 would increase to 10 patients on Thursday or Friday and then to 20 patients the following week. 
...
Flattening the curve means preventing a sharp peak in the number of cases, and spreading the infection rate over a longer period of time so that the health-care system is not overwhelmed. To understand how to flatten the curve, we first need to understand how the curve develops.  

There are three parts of the curve:  

1) The first part of the curve that sweeps upward. An epidemic spreads through a community by infecting people who are susceptible to infection. If an infected person comes into contact with many people who aren’t infected, the infection will spread quickly. 

2) The second part of the curve that levels. An epidemic will slow as the number of susceptible people decreases or preventive measures slow the spread. 

3) The third part of the curve that descends downward as fewer and fewer people develop COVID-19. 

Because COVID-19 is a new virus, the entire population was susceptible to COVID-19 infection at the beginning of the outbreak. Flattening the curve means slowing the spread amongst people who are susceptible to COVID-19.

<div class="more-info-images">
<img 
    src="/images/flatten-curve.png"
    alt="Flatten the curve diagram. Physical distancing reduces the height of the curve and the curve occurs further out in time. Two curves are presented -- with and without physical distancing."/>
</div>