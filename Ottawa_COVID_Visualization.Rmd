...
ott_observed <- read.csv(file.path(getwd(), "Data/Observed data/Ottawa_Observed_COVID_Data.csv"))
...
hosp_visualization(ott_projections, ott_observed, "hospitalizations", title = "Projected census of COVID-19 hospitalizations in Ottawa", y_label = "Census (# of patients)")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
source("R/covid_visualization.R")
hosp_visualization(ott_projections, ott_observed, "daily_hospitalizations", title = "Projected daily COVID-19 hospitalizations in Ottawa", y_label = "Census (# of patients)")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
source("R/covid_visualization.R")
hosp_visualization(ott_projections, ott_observed, "ICU", title = "Projected census of COVID-19 ICU patients in Ottawa", y_label = "Census (# of patients)")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
source("R/covid_visualization.R")
hosp_visualization(ott_projections, ott_observed, "daily_ICU", title = "Projected daily COVID-19 ICU admissions in Ottawa", y_label = "Census (# of patients)")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
source("R/covid_visualization.R")
hosp_visualization(ott_projections, ott_observed, "ventilators", title = "Projected census of COVID-19 ventilator usage in Ottawa", y_label = "Census (# of patients)")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
source("R/covid_visualization.R")
hosp_visualization(ott_projections, ott_observed, "daily_ventilators", title = "Projected daily COVID-19 ventilator usage in Ottawa", y_label = "Census (# of patients)")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
source("R/covid_visualization.R")
death_visualization(ott_projections, ott_observed, "total_deaths", title = "Projected number of COVID-19 total hospital deaths in Ottawa", y_label = "# of patients")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
source("R/covid_visualization.R")
death_visualization(ott_projections, ott_observed, "daily_deaths", title = "Projected number of COVID-19 daily hospital deaths in Ottawa", y_label = "# of patients")
```
