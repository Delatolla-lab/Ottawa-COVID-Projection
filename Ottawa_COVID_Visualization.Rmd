...
2) *Scenarios are based on effective physical distancing.* Effectiveness of preventive measures is the most influential parameter for all model platforms and projections - and hence the most important source of projection uncertainty.
...
3) *Projections are based on the [CHIME model](https://penn-chime.phl.io/) developed by the University of Pennsylvania Health System.* The projections can be updated for other models.
