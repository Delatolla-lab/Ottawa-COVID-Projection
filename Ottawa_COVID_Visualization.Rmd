...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
source("R/covid_visualization.R")
death_visualization(ott_projections, ott_observed, "daily_deaths", title = "Projected number of COVID-19 daily hospital deaths in Ottawa", y_label = "Census (# of patients)")
```

### Total projections
```{r, echo=FALSE, warning=FALSE, message=FALSE}
source("R/covid_visualization.R")
death_visualization(ott_projections, ott_observed, "total_deaths", title = "Projected number of COVID-19 total hospital deaths in Ottawa", y_label = "Census (# of patients)")
```
