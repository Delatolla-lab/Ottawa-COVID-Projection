...
trace4 <- list(
  ...
  mode = "markers+lines", 
  name = "Reported acute care patients", 
  type = "scatter", 
  xsrc = "wyusuf:6:949fbc", 
  x = ott_data$date, 
...
layout <- list(
  title = list(text = "Projected census of COVID-19 acute care patients in Ottawa"), 
  xaxis = list(
    side = "bottom", 
    type = "date", 
...
data <- list(trace1, trace2, trace3, trace4, trace5)
layout <- list(
  title = list(text = "Projected census of COVID-19 ICU patients in Ottawa"), 
  xaxis = list(
    type = "date", 
...
data <- list(trace1, trace2, trace3, trace4, trace5)
layout <- list(
  title = list(text = "Projected census of COVID-19 ventilator patients in Ottawa"), 
  xaxis = list(
    type = "date", 
    range = c("2020-03-05 14:13:30.5106", "2020-10-16"), 
    title = list(text = "Date"), 
