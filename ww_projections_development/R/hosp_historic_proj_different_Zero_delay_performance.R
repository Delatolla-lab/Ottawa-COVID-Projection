...
date_intervals <- c(0, 30, 60, 90, 120, 150, 180, 210, 240, 270)
...
save(hosp_data_forecast, file = "ww_projections_development/Data/ottawa_historic_hosp_proj_delay_0.RData")
