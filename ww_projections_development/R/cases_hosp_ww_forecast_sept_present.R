...
# save forecasts
save(cases_forecast_sep21_pres22, file = "ww_projections_development/sep21_present22_cases_proj.RData")
save(hosp_forecast_sep21_pres22, file = "ww_projections_development/sep21_present22_hosp_proj.RData")
save(ww_forecast_sep21_pres22, file = "ww_projections_development/sep21_present22_ww_proj.RData")
