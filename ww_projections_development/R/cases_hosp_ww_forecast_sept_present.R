...
# run case forecast
cases_forecast_sep21_pres22 <- short_term_forecast(
  data = ott_covid_data,
...
# run hosp forecast
hosp_forecast_sep21_pres22 <- short_term_forecast(
  data = ott_covid_data,
...
# run ww forecast
ww_forecast_sep21_pres22 <- short_term_forecast(
  data = ww_clean,
...
# save forecasts
save(cases_forecast_sep21_pres22, file = "ww_projections_development/Data/sep21_present22_cases_proj.RData")
save(hosp_forecast_sep21_pres22, file = "ww_projections_development/Data/sep21_present22_hosp_proj.RData")
save(ww_forecast_sep21_pres22, file = "ww_projections_development/Data/sep21_present22_ww_proj.RData")
...
# save forecasts
save(hosp_forecast_sep21_pres22_delay_10, file = "ww_projections_development/Data/sep21_present22_hosp_proj_delay_10.RData")
...
# save forecasts
save(hosp_forecast_sep21_pres22_delay_14, file = "ww_projections_development/Data/sep21_present22_hosp_proj_delay_14.RData")
