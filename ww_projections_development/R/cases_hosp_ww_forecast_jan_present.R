...
# run case forecast
cases_forecast_jan22_pres22 <- short_term_forecast(
  data = ott_covid_data,
...
# run hosp forecast
hosp_forecast_jan22_pres22 <- short_term_forecast(
  data = ott_covid_data,
...
# run ww forecast
ww_forecast_jan22_pres22 <- short_term_forecast(
  data = ww_clean,
...
# run hosp forecast
hosp_forecast_jan22_pres22_delay_10 <- short_term_forecast(
  data = ott_covid_data,
  input = "observed_census_ICU_p_acute_care",
  start_date = "2022-01-01",
  input_multiplier = 1,
...
# run hosp forecast
hosp_forecast_jan22_pres22_delay_14 <- short_term_forecast(
  data = ott_covid_data,
  input = "observed_census_ICU_p_acute_care",
  start_date = "2022-01-01",
  input_multiplier = 1,
