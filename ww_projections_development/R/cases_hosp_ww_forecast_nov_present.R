...
# run case forecast
cases_forecast_nov21_pres22 <- short_term_forecast(
  data = ott_covid_data,
...
# run hosp forecast
hosp_forecast_nov21_pres22 <- short_term_forecast(
  data = ott_covid_data,
...
# run ww forecast
ww_forecast_nov21_pres22 <- short_term_forecast(
  data = ww_clean,
...
# save forecasts
save(cases_forecast_nov21_pres22, file = "ww_projections_development/Data/nov21_present22_cases_proj.RData")
save(hosp_forecast_nov21_pres22, file = "ww_projections_development/Data/nov21_present22_hosp_proj.RData")
save(ww_forecast_nov21_pres22, file = "ww_projections_development/Data/nov21_present22_ww_proj.RData")
...
# run hosp forecast
hosp_forecast_nov21_pres22_delay_10 <- short_term_forecast(
  data = ott_covid_data,
  input = "observed_census_ICU_p_acute_care",
  start_date = "2021-11-01",
  input_multiplier = 1,
...
# save forecasts
save(hosp_forecast_nov21_pres22_delay_10, file = "ww_projections_development/Data/nov21_present22_hosp_proj_delay_10.RData")
...
# run hosp forecast
hosp_forecast_nov21_pres22_delay_14 <- short_term_forecast(
  data = ott_covid_data,
  input = "observed_census_ICU_p_acute_care",
  start_date = "2021-11-01",
  input_multiplier = 1,
...
# save forecasts
save(hosp_forecast_nov21_pres22_delay_14, file = "ww_projections_development/Data/nov21_present22_hosp_proj_delay_14.RData")
