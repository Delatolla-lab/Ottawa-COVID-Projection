...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
load("dec21_present22_cases_proj.RData")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
load("dec21_present22_hosp_proj.RData")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
load("dec21_present22_ww_proj.Rdata")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
save(final_merged_data, file = "merged_data_cases_hosp_ww_dec_present.RData")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
save(joined_with_observed_cases, file = "merged_data_cases_hosp_ww_observed_dec_present.RData")
```


# Loading the forecasted hospital case data from September2021 to present for 10 days reporting delay
```{r, echo=FALSE, warning=FALSE, message=FALSE}
load("dec21_present22_hosp_proj_delay_10.RData")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
load("dec21_present22_hosp_proj_delay_14.RData")
```
