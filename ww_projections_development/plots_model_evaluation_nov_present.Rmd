...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
load("Data/nov21_present22_cases_proj.RData")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
estimates_hosp_cases = hosp_forecast_nov21_pres22_delay_10[[2]]
print(estimates_hosp_cases)
```
# Current growth rate estimates for hospital census data with reporting delay of 10 days
```{r, echo=FALSE, warning=FALSE, message=FALSE}
estimates_hosp_cases = hosp_forecast_nov21_pres22_delay_14[[2]]
print(estimates_hosp_cases)
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
load("Data/nov21_present22_ww_proj.Rdata")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
save(final_merged_data, file = "Data/merged_data_cases_hosp_ww_nov_present.RData")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
save(joined_with_observed_cases, file = "Data/merged_data_cases_hosp_ww_observed_nov_present.RData")
```
