...
# save forecasts
save(cases_forecast_dec21_pres22, file = "ww_projections_development/dec21_present22_cases_proj.RData")
save(hosp_forecast_dec21_pres22, file = "ww_projections_development/dec21_present22_hosp_proj.RData")
save(ww_forecast_dec21_pres22, file = "ww_projections_development/dec21_present22_ww_proj.RData")
...
# save forecasts
save(hosp_forecast_dec21_pres22_delay_10, file = "ww_projections_development/dec21_present22_hosp_proj_delay_10.RData")
...
# save forecasts
save(hosp_forecast_dec21_pres22_delay_14, file = "ww_projections_development/dec21_present22_hosp_proj_delay_14.RData")
