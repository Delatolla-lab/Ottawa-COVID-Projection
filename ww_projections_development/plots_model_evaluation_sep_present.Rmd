---
title: "Plots of projections from Sept2021 to Present"
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
load("sep21_present22_cases_proj.RData")
```

# Current growth estimates for observed new case data
```{r, echo=FALSE, warning=FALSE, message=FALSE}
estimates_cases = cases_forecast_sep21_pres22[[2]]
...
short_term_plot(
  projections = cases_forecast_sep21_pres22[[1]], # projection data
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
load("sep21_present22_hosp_proj.RData")
```

# Current growth rate estimates for hospital census data
```{r, echo=FALSE, warning=FALSE, message=FALSE}
estimates_hosp_cases = hosp_forecast_sep21_pres22[[2]]
...
# Visualizing projections
short_term_plot(
  projections = hosp_forecast_sep21_pres22[[1]], # projection data
  obs_data = ott_covid_data, # observed data
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
load("sep21_present22_ww_proj.Rdata")
```


# Current growth estimates of waste water data
```{r, echo=FALSE, warning=FALSE, message=FALSE}
estimates_ww_data = ww_forecast_sep21_pres22[[2]]
...
# Visualizing projections
short_term_plot(
  projections = ww_forecast_sep21_pres22[[1]], # projection data
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
save(final_merged_data, file = "merged_data_cases_hosp_ww_sep_present.RData")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
save(joined_with_observed_cases, file = "merged_data_cases_hosp_ww_observed_sep_present.RData")
```


# Loading the forecasted hospital case data from September2021 to present for 10 days reporting delay
```{r, echo=FALSE, warning=FALSE, message=FALSE}
load("sep21_present22_hosp_proj_delay_10.RData")
```
...
# Visualizing projections
short_term_plot(
  projections = hosp_forecast_sep21_pres22_delay_10[[1]], # projection data
  obs_data = ott_covid_data, # observed data
  obs_column = "observed_census_ICU_p_acute_care", # observed data column
  forecast_type = "reported_cases", # forecast type
  ylab = "Hospital cases over time", # yaxis label
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
load("sep21_present22_hosp_proj_delay_14.RData")
```
...
# Visualizing projections
short_term_plot(
  projections = hosp_forecast_sep21_pres22_delay_14[[1]], # projection data
  obs_data = ott_covid_data, # observed data
  obs_column = "observed_census_ICU_p_acute_care", # observed data column
  forecast_type = "reported_cases", # forecast type
  ylab = "Hospital cases over time", # yaxis label
...
hosp_data_delay_10 = hosp_forecast_sep21_pres22_delay_10[[1]] %>%
  filter(variable == "reported_cases") %>%
...
hosp_data_delay_14 = hosp_forecast_sep21_pres22_delay_14[[1]] %>%
  filter(variable == "reported_cases") %>%
