...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
source("../R/covid_visualization.R")
hosp_visualization(ott_projections, ott_observed, "new_acute_care", title = "Projected daily acute COVID-19 hospitalizations in Ottawa", y_label = "New admissions (# of patients)")
```
