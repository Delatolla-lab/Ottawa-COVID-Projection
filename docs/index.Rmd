...
hosp_visualization(ott_projections, ott_observed, "census_acute_care_p_ICU", title = "Projected census of COVID-19 hospitalizations (acute + ICU) in Ottawa", y_label = "Census (# of patients)", annote = TRUE)
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
source("../R/covid_visualization.R")
hosp_visualization(ott_projections, ott_observed, "new_acute_care_p_ICU", title = "Projected daily COVID-19 hospitalizations (acute + ICU) in Ottawa", y_label = "New admissions (# of patients)")
```
...
- Census (acute and ICU) = 24 patients, Ottawa hospital census data to 2020-04-01.
