...
hosp_visualization(ott_projections, ott_observed, "census_acute_care", title = "Projected census of acute COVID-19 hospitalizations in Ottawa", y_label = "Census (# of patients)", annote = TRUE)
```
...
source("../R/covid_visualization.R")
source("../R/estimate_scripts.R")
hosp_visualization(ott_projections, ott_observed, "new_acute_care", title = "Projected daily COVID-19 hospitalizations (acute + ICU) in Ottawa", y_label = "New admissions (# of patients)")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
source("../R/covid_visualization.R")
death_visualization(ott_projections, ott_observed, "cumulative_deaths", title = "Projected cumulative number of COVID-19 hospital deaths in Ottawa", y_label = "Reported deaths")
```
