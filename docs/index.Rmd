...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
datatable(ott_projections, caption = htmltools::tags$caption("Projected data", style="font-size: 20px"), options = list(pageLength = -1, lengthMenu = list(c(-1, 15), c("All", 15)), scrollX = TRUE))
datatable(ott_observed, caption = htmltools::tags$caption("Reported hospital use and deaths from Ottawa Public Health", style="font-size: 20px"), options = list(pageLength = -1, lengthMenu = list(c(-1, 15), c("All", 15)), scrollX = TRUE))
```
...
**Acknowledgements:** Warsame Yusuf, Rostyslav Vyuha, Yulric Sequeira, Yulric
